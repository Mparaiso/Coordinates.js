define (require)->
    getFlickApiUrl:(options)->
        ...
        "http://api.flickr.com/services/rest/?method=flickr.photos.search&api_key=a47e50dcce48c46c58f9b8c622c42a18&sort=relevance&text=#{key}&per_page=#{quantity}&format=json&jsoncallback=?"
