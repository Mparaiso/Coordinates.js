...
(function (coordinate) {
    (function (events) {
        var EventDispatcher = (function () {
            ...
            EventDispatcher.prototype.addEventListener = function (events, callback) {
                debugger;
                if (callback == null)
                    return this;
                var _events = events.split(EventDispatcher.eventSplitter);
                var event = null;
            ...
            EventDispatcher.prototype.removeEventListener = function (events_, callback) {
                if (typeof callback === "undefined") { callback = null; }
                if (Object.keys(this.callbacks).length <= 0)
                    return this;
                var events = events_ != null ? events_.split(EventDispatcher.eventSplitter) : Object.keys(this.callbacks);
                var event = null;
            ...
            EventDispatcher.prototype.dispatchEvent = function (events_, rest) {
                if (typeof rest === "undefined") { rest = null; }
                if (this.callbacks == null)
                    return this;
                var all = this.callbacks["all"];
                var events = events_.split(EventDispatcher.eventSplitter);
                var event = null;
                while (events.length > 0) {
                    event = events.shift();
                    var node = this.callbacks[event];
