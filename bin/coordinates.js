...
define('layouts/layouts',['require','./Layout','./twodee/Layout2d','./twodee/VerticalLine','./twodee/HorizontalLine','./twodee/Ellipse','./twodee/Wave','./twodee/Stack','./twodee/Spiral','./twodee/Grid','./twodee/Scatter'],function(require) {
  return {
    Layout: require("./Layout"),
    twodee: {
