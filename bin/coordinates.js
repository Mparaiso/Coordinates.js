...
define('nodes/twodee/FlowNode',['require','./Node2d'],function(require) {
  ...
  return FlowNode = (function(_super) {
    ...
    */
    ...
    FlowNode.prototype.getWidth = function() {
      return this._link.getWidth();
    };

    FlowNode.prototype.getHeight = function() {
      return this._link.getHeight();
    };
...
define('layouts/Layout',['require','../events/helpers/EventDispatcher','../events/NodeEvent','../constants/LayoutUpdateMethod'],function(require) {
...
define('layouts/twodee/VerticalLine',['require','./Layout2d','../../nodes/twodee/OrderedNode','../../events/NodeEvent'],function(require) {
  ...
  return VerticalLine = (function(_super) {
    ...
    VerticalLine.prototype.renderNode = function(node) {
      VerticalLine.__super__.renderNode.call(this, node);
      return node.getLink().setRotation(0);
    };
...
define('layouts/twodee/HorizontalLine',['require','./Layout2d','../../events/NodeEvent','../../nodes/twodee/OrderedNode'],function(require) {
  ...
  return HorizontalLine = (function(_super) {
    ...
    HorizontalLine.prototype.renderNode = function(node) {
      HorizontalLine.__super__.renderNode.call(this, node);
      return node.getLink().setRotation(0);
    };
...
define('layouts/twodee/Grid',['require','./Layout2d','../../constants/GridLayoutDirection','../../events/NodeEvent','../../nodes/twodee/GridNode'],function(require) {
  ...
  */
  ...
  return Grid = (function(_super) {
    ...
    Grid.prototype.renderNode = function(node) {
      Grid.__super__.renderNode.call(this, node);
      return node.getLink().setRotation(0);
    };
      ...
      */
      ...
      if (!(((_ref = this.nodes) != null ? _ref.length : void 0) <= 0)) {
        ...
        for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
          node = _ref1[_i];
          node.setX(node.getXRelation() * this._width);
          _results.push(node.setY(node.getYRelation() * this._height));
        }
        return _results;
      }
    };
...
define('layouts/twodee/Flow',['require','./Layout2d','../../events/NodeEvent','../../nodes/twodee/FlowNode','../../constants/FlowOverflowPolicy','../../constants/FlowAlignment','../../constants/FlowDirection'],function(require) {
  ...
  return Flow = (function(_super) {
    ...
    Flow.prototype.renderNode = function(node) {
      Flow.__super__.renderNode.call(this, node);
      return node.getLink().setRotation(0);
    };
...
define('layouts/twodee/Lattice',['require','./Layout2d','../../events/NodeEvent','../../constants/LatticeOrder','../../constants/LatticeType','../../constants/LatticeAlternationPattern','../../nodes/twodee/GridNode'],function(require) {
  ...
  return Lattice = (function(_super) {
    ...
    */
    ...
    Lattice.prototype.renderNode = function(node) {
      Lattice.__super__.renderNode.call(this, node);
      node.getLink().setRotation(0);
    };
...
define('layouts/twodee/Quadric',['require','./Layout2d','../../events/NodeEvent','../../constants/PathAlignType'],function(require) {
  var Layout2d, NodeEvent, PathAlignType, Quadric;
  Layout2d = require('./Layout2d');
  NodeEvent = require("../../events/NodeEvent");
  PathAlignType = require("../../constants/PathAlignType");
  return Quadric = (function(_super) {

    __extends(Quadric, _super);

    function Quadric(x, y, x1, y1, x2, y2, x3, y3, x4, y4, jitterX, jitterY) {
      if (jitterX == null) {
        jitterX = 0;
      }
      if (jitterY == null) {
      ...
      Quadric.__super__.constructor.call(this, x, y, jitterX, jitterY);
      this.initConfig({
        x1: x1,
        y1: y1,
        x2: x2,
    ...
    Quadric.prototype.update = function() {
      /* 
          EN : update nodes
          FR : met à jour les nodes selon la courbe quadrique
      */

      var i, node, t, x1, x2, x3, x4, xt, y1, y2, y3, y4, yt, _i, _len, _ref;
      if (this.nodes.length <= 0) {
        return;
      }
      t = 0;
      ...
      for (i = _i = 0, _len = _ref.length; _i < _len; i = ++_i) {
        ...
        node.setX(this._x + xt + node.getJitterX() * this._jitterX);
        node.setY(this._y + yt + node.getJitterY() * this._jitterY);
        t += 1 / this.nodes.length;
      }
    };
...
define('layouts/layouts',['require','./Layout','./twodee/Layout2d','./twodee/VerticalLine','./twodee/HorizontalLine','./twodee/Ellipse','./twodee/Wave','./twodee/Stack','./twodee/Spiral','./twodee/Grid','./twodee/Scatter','./twodee/Flow','./twodee/Lattice','./twodee/Quadric'],function(require) {
  return {
    Layout: require("./Layout"),
    twodee: {
...
define('utils/ES5shims',['require'],function(require) {
  ...
  if ((_ref1 = (_base1 = Array.prototype).isArray) == null) {
    _base1.isArray = function() {
      return Array.prototype.constructor === this.constructor && typeof this.length === "number";
    };
  }
